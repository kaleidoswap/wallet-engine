 ...
 * silently corrupt: NaN/Infinity (a renamed field), negatives (a hostile maker
 * poisoning net-amount math), or magnitudes past `Number.MAX_SAFE_INTEGER`. Every
 * field coerced is non-negative by definition.
 */
